...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    if self.CP.openpilotLongitudinalControl:
      ...
      ret.cruiseState.available = True #cp.vl["TCS13"]["ACCEnable"] == 0 or True #notetoself
    ...
    self.brake_hold = cp.vl["TCS15"]["AVH_LAMP"] == 2 and not self.CP.openpilotLongitudinalControl # 0 OFF, 1 ERROR, 2 ACTIVE, 3 READY
    self.brake_error = cp.vl["TCS13"]["ACCEnable"] != 0 and not self.CP.openpilotLongitudinalControl # 0 ACC CONTROL ENABLED, 1-3 ACC CONTROL DISABLED
